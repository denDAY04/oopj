 ...
 * destination, command or status, data length, and checksum. The size and order
 * of the header components are defined by the concrete subclasses.
 *
 * @author ibr, hbe
 * @version 2012/10/11
 */
public abstract class Packet {
     ...
     * @param data
     */
    public Packet(String source, String destination, String commandStatus,
            String data) {
        this.source = source;
     ...
     * byte array with the value specified in the datalength field plus the
     * header length. The <code> abstract isPacketComplete</code> method is the
     * "algorithm interface" for a concrete strategy class in the Strategy
     * design pattern. The <code>Packet</code> class is the abstract Strategy
     * class and the <code>SerialFrame</code> class is the Context class.
     *
