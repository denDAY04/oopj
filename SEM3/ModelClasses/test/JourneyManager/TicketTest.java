...
public class TicketTest {
    ...
    public void setUp() {
        ...
        instance = new Ticket();
        instance.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
    }
    ...
    public void testCreateTicket() {
        ...
        expResutl.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
    ...
    public void testEquals() {
        ...
        other.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
