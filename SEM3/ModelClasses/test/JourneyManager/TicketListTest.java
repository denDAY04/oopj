...
public class TicketListTest {
    ...
    public void setUp() {
        ...
        ticket.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
    ...
    public void testSetAllTickets() {
        ...
        ticket2.createTicket(number2, time2, price2, startZone2,zoneCount,
                             custommerNumber2);
    ...
    public void testGetTicket() {
        ...
        expResult.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
    ...
    public void testMergeWith() {
        ...
        custommerNumber = 1;
        Ticket ticket2 = new Ticket();
        ticket2.createTicket(number, time, price, startZone, zoneCount, custommerNumber);
